package com.tomojo.config.jdbc;
...
public class JDBCDaoSpringConfig {
    ...
    @Value("${com.tomojo.transaction.driverClassName}")
    private String driverClassName;

    @Value("${com.tomojo.transaction.url}")
    private String url;

    @Value("${com.tomojo.transaction.userName}")
    private String userName;

    @Value("${com.tomojo.transaction.password}")
